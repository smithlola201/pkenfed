    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 px-6 pb-8 mt-10">
        <div className="max-w-full md:max-w-sm mx-auto">
          <div className="bg-white rounded-sm p-6 py-11">
            <form onSubmit={handleSubmit} className="space-y-7">
              <div className="space-y-2">
                <Label htmlFor="username" className="text-foreground">
                  Username
                </Label>
                <Input id="username" type="text" value={username} onChange={e => setUsername(e.target.value)} className="h-10 rounded bg-white border border-gray-400/50" required />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-10 rounded bg-white border border-gray-400/50 pr-12"
                    required
                  />
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-10 bg-[#03549b] text-white rounded font-semibold text-lg transition-opacity hover:opacity-90 active:scale-[0.98] disabled:opacity-70 flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
      ...
      <footer className="py-6 text-center">
        <p className="text-xs text-gray-500">©2026 Pentagon Federal Credit Union</p>
      </footer>
    </div>
  );
}
